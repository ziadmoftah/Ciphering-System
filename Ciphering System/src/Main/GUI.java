...
public class GUI extends javax.swing.JFrame {
    ...
    private void Enc_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Enc_ButtonActionPerformed
        ...
        if (  String.valueOf(jComboBox1.getSelectedItem()).equals("Caeser Cipher")){
            Caeser C ;
            if (flag)
               C  = new Caeser (jTextField2.getText()); 
            else
                C  = new Caeser (jTextField2.getText() ,jTextField1.getText()); 
            ...
            HillCipher C;
            if (flag)
                C = new HillCipher (jTextField2.getText()); 
            else
                C = new HillCipher (jTextField2.getText() ,jTextField1.getText()); 
            jTextField3.setText(C.Encrypt());
            ...
            PlayFair C;
            if (flag)
                C  = new PlayFair (jTextField2.getText()); 
            else
                 C  = new PlayFair (jTextField2.getText() ,jTextField1.getText()); 
            jTextField3.setText(C.Encrypt());
            ...
            Rail_Fence C;
            //if (flag)
              //  C  = new Rail_Fence (jTextField2.getText()); 
            //else
                 C  = new Rail_Fence (jTextField2.getText() ,Integer.valueOf(jTextField1.getText())); 
            jTextField3.setText(C.Encrypt());
            ...
            VigenereAutoKey C;
            if (flag)
                C  = new VigenereAutoKey (jTextField2.getText()); 
            else
                 C  = new VigenereAutoKey (jTextField2.getText() ,jTextField1.getText()); 
            jTextField3.setText(C.Encrypt());
            ...
            if (flag)
                C  = new VigenereWithReapeatingKey (jTextField2.getText()); 
            else
                 C  = new VigenereWithReapeatingKey (jTextField2.getText() ,jTextField1.getText()); 
            jTextField3.setText(C.Encrypt());
